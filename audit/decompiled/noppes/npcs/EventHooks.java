...
public class EventHooks {
    ...
    public static boolean onNPCDialog(EntityNPCInterface npc, EntityPlayer player, Dialog dialog) {
        ...
        PlayerData.get((EntityPlayer)player).scriptData.runScript(EnumScriptType.DIALOG, event);
        return WrapperNpcAPI.EVENT_BUS.post((Event)event);
    }
    ...
    public static void onScriptItemUpdate(ItemScriptedWrapper handler, EntityPlayer player) {
        ...
        ItemEvent.UpdateEvent event = new ItemEvent.UpdateEvent(handler, PlayerData.get((EntityPlayer)player).scriptData.getPlayer());
        handler.runScript(EnumScriptType.TICK, event);
        WrapperNpcAPI.EVENT_BUS.post((Event)event);
    }

    public static boolean onScriptItemTossed(ItemScriptedWrapper handler, EntityPlayer player, EntityItem entity) {
        ItemEvent.TossedEvent event = new ItemEvent.TossedEvent(handler, PlayerData.get((EntityPlayer)player).scriptData.getPlayer(), (IEntityItem)NpcAPI.Instance().getIEntity((Entity)entity));
    ...
    public static boolean onScriptItemPickedUp(ItemScriptedWrapper handler, EntityPlayer player, EntityItem entity) {
        ItemEvent.PickedUpEvent event = new ItemEvent.PickedUpEvent(handler, PlayerData.get((EntityPlayer)player).scriptData.getPlayer(), (IEntityItem)NpcAPI.Instance().getIEntity((Entity)entity));
