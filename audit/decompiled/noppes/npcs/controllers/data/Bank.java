...
public class Bank {
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.func_74782_a("BankCurrency", (NBTBase)this.currencyInventory.getToNBT());
        nbttagcompound.func_74782_a("BankUpgrade", (NBTBase)this.upgradeInventory.getToNBT());
        ...
        nbttagcompound.func_74782_a("BankTypes", (NBTBase)NBTTags.nbtIntegerIntegerMap(this.slotTypes));
    }
    ...
    public int getMaxSlots() {
        for (int i = 0; i < this.maxSlots; ++i) {
            if (this.currencyInventory.func_70301_a(i) != null && !this.currencyInventory.func_70301_a(i).func_190926_b() || i <= this.startSlots - 1) continue;
            return i;
        }
