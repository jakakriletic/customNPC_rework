...
public class BlockData {
    ...
    public NBTTagCompound getNBT() {
        ...
        compound.func_74778_a("Block", ((ResourceLocation)Block.field_149771_c.func_177774_c((Object)this.state.func_177230_c())).toString());
        compound.func_74768_a("Meta", this.state.func_177230_c().func_176201_c(this.state));
        if (this.tile != null) {
            compound.func_74782_a("Tile", (NBTBase)this.tile);
        }
        return compound;
    }
