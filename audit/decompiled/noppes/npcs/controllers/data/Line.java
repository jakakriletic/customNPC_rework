...
public class Line {
    ...
    public Line formatTarget(EntityLivingBase entity) {
        ...
        Line line = this.copy();
        line.text = entity instanceof EntityPlayer ? line.text.replace("@target", ((EntityPlayer)entity).getDisplayNameString()) : line.text.replace("@target", entity.func_70005_c_());
        return line;
    }
}
