...
public class DataTransform {
    ...
    public NBTTagCompound getDisplay() {
        ...
        if (this.npc instanceof EntityCustomNpc) {
            compound.func_74782_a("ModelData", (NBTBase)((EntityCustomNpc)this.npc).modelData.writeToNBT());
        }
        return compound;
    }
    ...
    public void transform(boolean isActive) {
        ...
        if (this.hasDisplay) {
            ...
            if (this.npc instanceof EntityCustomNpc) {
                ((EntityCustomNpc)this.npc).modelData.readFromNBT(NBTTags.NBTMerge(compound.func_74775_l("ModelData"), this.display.func_74775_l("ModelData")));
            }
