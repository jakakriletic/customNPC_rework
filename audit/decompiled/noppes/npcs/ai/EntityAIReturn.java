...
extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        ...
        if (this.npc.ais.findShelter == 0 && (!this.npc.field_70170_p.func_72935_r() || this.npc.field_70170_p.func_72896_J()) && !this.npc.field_70170_p.field_73011_w.func_191066_m() ? this.npc.field_70170_p.func_175678_i(pos = new BlockPos((double)this.npc.getStartXPos(), this.npc.getStartYPos(), (double)this.npc.getStartZPos())) || this.npc.field_70170_p.func_175699_k(pos) <= 8 : this.npc.ais.findShelter == 1 && this.npc.field_70170_p.func_72935_r() && this.npc.field_70170_p.func_175678_i(pos = new BlockPos((double)this.npc.getStartXPos(), this.npc.getStartYPos(), (double)this.npc.getStartZPos()))) {
            return false;
        }
    ...
    private void navigate(boolean towards) {
        ...
        if (range > (double)CustomNpcs.NpcNavRange || towards) {
            ...
            if (distance > 2 && (pos = RandomPositionGenerator.func_75464_a((EntityCreature)this.npc, (int)distance, (int)(distance / 2 > 7 ? 7 : distance / 2), (Vec3d)(start = new Vec3d(posX, posY, posZ)))) != null) {
