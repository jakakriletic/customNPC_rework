...
extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        ...
        if (this.watchedClass == EntityPlayer.class) {
            this.closestEntity = this.npc.field_70170_p.func_72890_a((Entity)this.npc, (double)this.field_75333_c);
        } else {
            this.closestEntity = this.npc.field_70170_p.func_72857_a(this.watchedClass, this.npc.func_174813_aQ().func_72314_b((double)this.field_75333_c, 3.0, (double)this.field_75333_c), (Entity)this.npc);
    ...
    public boolean func_75253_b() {
        ...
        return !this.npc.isInRange(this.closestEntity, this.field_75333_c) ? false : this.lookTime > 0;
    }
