            ...
            for (int y = -2; y <= 2; ++y) {
                ...
                for (int x = -i; x <= i; ++x) {
                    ...
                    for (int z = -i; z <= i; ++z) {
                        ...
                        if (!this.isOpaque((int)j, (int)k, (int)l) || this.isOpaque((int)j, (int)k + 1, (int)l) || !this.isOpaque((int)j, (int)k + 2, (int)l) || (movingobjectposition = this.world.func_72933_a(vec1 = new Vec3d(this.targetEntity.field_70165_t, this.targetEntity.field_70163_u + (double)this.targetEntity.func_70047_e(), this.targetEntity.field_70161_v), vec2 = new Vec3d(j, k + (double)this.npc.func_70047_e(), l))) == null || this.shelterX == j || this.shelterY == k || this.shelterZ == l) continue;
