...
extends JobInterface {
    ...
    public boolean aiShouldExecute() {
        ...
        this.healTicks = 0;
        this.affected = this.npc.field_70170_p.func_72872_a(EntityLivingBase.class, this.npc.func_174813_aQ().func_72314_b((double)this.range, (double)this.range / 2.0, (double)this.range));
