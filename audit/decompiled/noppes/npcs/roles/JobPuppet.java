...
implements IJobPuppet {
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound) {
        ...
        compound.func_74782_a("PuppetHead2", (NBTBase)this.head2.writeNBT());
        compound.func_74782_a("PuppetLArm2", (NBTBase)this.larm2.writeNBT());
        compound.func_74782_a("PuppetRArm2", (NBTBase)this.rarm2.writeNBT());
        compound.func_74782_a("PuppetBody2", (NBTBase)this.body2.writeNBT());
        compound.func_74782_a("PuppetLLeg2", (NBTBase)this.lleg2.writeNBT());
        compound.func_74782_a("PuppetRLeg2", (NBTBase)this.rleg2.writeNBT());
    ...
    private float calcRotation(float r, float r2, float partialTicks) {
        ...
        if (this.prevTicks != this.npc.field_70173_aa) {
            ...
            this.val = 1.0f - (MathHelper.func_76134_b((float)((float)ticks / speed * (float)Math.PI / 2.0f)) + 1.0f) / 2.0f;
            this.valNext = 1.0f - (MathHelper.func_76134_b((float)((float)(ticks + 1) / speed * (float)Math.PI / 2.0f)) + 1.0f) / 2.0f;
