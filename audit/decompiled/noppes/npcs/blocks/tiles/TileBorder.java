...
ITickable {
    ...
    public void func_145839_a(NBTTagCompound compound) {
        ...
        if (this.func_145831_w() != null) {
            this.func_145831_w().func_175656_a(this.func_174877_v(), CustomItems.border.func_176223_P().func_177226_a((IProperty)BlockBorder.ROTATION, (Comparable)Integer.valueOf(this.rotation)));
        }
    }
    ...
    public void func_73660_a() {
        ...
        List list = this.field_145850_b.func_175647_a(Entity.class, box, (Predicate)this);
        for (Entity entity : list) {
            ...
            BlockPos pos2 = new BlockPos((Vec3i)this.field_174879_c);
            if (this.rotation == 2) {
