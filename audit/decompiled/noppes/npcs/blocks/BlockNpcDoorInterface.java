    ...
    public IBlockState func_176221_a(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        if (state.func_177229_b((IProperty)field_176523_O) == BlockDoor.EnumDoorHalf.LOWER) {
            ...
            if (iblockstate1.func_177230_c() == this) {
                state = state.func_177226_a((IProperty)field_176521_M, iblockstate1.func_177229_b((IProperty)field_176521_M)).func_177226_a((IProperty)field_176522_N, iblockstate1.func_177229_b((IProperty)field_176522_N));
            }
        } else {
            IBlockState iblockstate1 = worldIn.func_180495_p(pos.func_177977_b());
            if (iblockstate1.func_177230_c() == this) {
                state = state.func_177226_a((IProperty)field_176520_a, iblockstate1.func_177229_b((IProperty)field_176520_a)).func_177226_a((IProperty)field_176519_b, iblockstate1.func_177229_b((IProperty)field_176519_b));
            }
        }
        return state;
    }
