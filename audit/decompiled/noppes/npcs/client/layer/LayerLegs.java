...
implements LayerPreRender {
    ...
    private void renderTails(float par7) {
        ...
        GlStateManager.func_179109_b((float)(config.transX * par7), (float)(config.transY + this.rotationPointY * par7), (float)(config.transZ * par7 + this.rotationPointZ * par7));
        GlStateManager.func_179109_b((float)0.0f, (float)0.0f, (float)((config.scaleZ - 1.0f) * 5.0f * par7));
        GlStateManager.func_179152_a((float)config.scaleX, (float)config.scaleY, (float)config.scaleZ);
        this.preRender(data);
        if (data.type == 0) {
            if (data.pattern == 1) {
    ...
    private void renderLegs(float par7) {
        ...
        this.preRender(data);
        if (data.type == 1) {
            GlStateManager.func_179109_b((float)0.0f, (float)(config.transY * 2.0f), (float)(config.transZ * par7 + 0.04f));
            GlStateManager.func_179152_a((float)config.scaleX, (float)config.scaleY, (float)config.scaleZ);
            this.naga.func_78785_a(par7);
        } else if (data.type == 2) {
            GlStateManager.func_179137_b((double)0.0, (double)((double)(config.transY * 1.76f) - 0.1 * (double)config.scaleY), (double)(config.transZ * par7));
            GlStateManager.func_179152_a((float)1.06f, (float)1.06f, (float)1.06f);
            GlStateManager.func_179152_a((float)config.scaleX, (float)config.scaleY, (float)config.scaleZ);
            this.spiderLegs.func_78785_a(par7);
        } else if (data.type == 3) {
            if (config.scaleY >= 1.0f) {
                GlStateManager.func_179109_b((float)0.0f, (float)(config.transY * 1.76f), (float)(config.transZ * par7));
            } else {
                GlStateManager.func_179109_b((float)0.0f, (float)(config.transY * 1.86f), (float)(config.transZ * par7));
            }
            GlStateManager.func_179152_a((float)0.79f, (float)(0.9f - config.scaleY / 10.0f), (float)0.79f);
            GlStateManager.func_179152_a((float)config.scaleX, (float)config.scaleY, (float)config.scaleZ);
    ...
    public void preRender(EntityCustomNpc player) {
        ...
        ModelPartData data = this.playerdata.getPartData(EnumParts.LEGS);
        this.model.field_178721_j.field_78807_k = data == null || data.type != 0;
        this.model.field_178722_k.field_78807_k = this.model.field_178721_j.field_78807_k;
    }
}
