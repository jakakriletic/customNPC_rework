...
extends LayerInterface {
    ...
    public void render(float par2, float par3, float par4, float par5, float par6, float par7) {
        ...
        GlStateManager.func_179109_b((float)config.transX, (float)config.transY, (float)config.transZ);
        ...
        float f16 = this.npc.field_70126_B + (this.npc.field_70177_z - this.npc.field_70126_B) * par7;
        float f13 = 5.0f;
        if (this.npc.func_70093_af()) {
            f13 += 25.0f;
        }
        GlStateManager.func_179114_b((float)(6.0f + f14 / 2.0f + f13), (float)1.0f, (float)0.0f, (float)0.0f);
        GlStateManager.func_179114_b((float)(f15 / 2.0f), (float)0.0f, (float)0.0f, (float)1.0f);
        GlStateManager.func_179114_b((float)(-f15 / 2.0f), (float)0.0f, (float)1.0f, (float)0.0f);
