...
extends CommonProxy {
    ...
    public void postload() {
        ...
        Minecraft.func_71410_x().getItemColors().func_186730_a((stack, tintIndex) -> 9127187, new Item[]{CustomItems.mount, CustomItems.cloner, CustomItems.moving, CustomItems.scripter, CustomItems.wand, CustomItems.teleporter});
    ...
    private GuiScreen getGui(EntityNPCInterface npc, EnumGuiType gui, Container container, int x, int y, int z) {
        ...
        if (gui == EnumGuiType.MainMenuDisplay) {
            ...
            if (gui == EnumGuiType.ScriptItem) {
                return new GuiScriptItem((EntityPlayer)Minecraft.func_71410_x().field_71439_g);
            }
