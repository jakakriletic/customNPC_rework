...
IGuiData {
    ...
    public GuiNpcQuestTypeDialog(EntityNPCInterface npc, Quest q, GuiScreen parent) {
        ...
        Client.sendData(EnumPacketServer.QuestDialogGetTitle, this.quest.dialogs.containsKey(0) ? this.quest.dialogs.get(0) : Integer.valueOf(-1), this.quest.dialogs.containsKey(1) ? this.quest.dialogs.get(1) : Integer.valueOf(-1), this.quest.dialogs.containsKey(2) ? this.quest.dialogs.get(2) : Integer.valueOf(-1));
    }
    ...
    protected void func_146284_a(GuiButton guibutton) {
        ...
        if (button.field_146127_k >= 9 && button.field_146127_k < 15) {
            int slot = button.field_146127_k - 9;
