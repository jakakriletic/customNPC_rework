...
implements ISubGuiListener {
    ...
    public void func_73866_w_() {
        ...
        this.addButton(new GuiNpcButton(1, this.guiLeft + 4, y += 23, 50, 20, new String[]{"availability.always", "availability.after", "availability.before"}, this.availabitily.dialog2Available.ordinal()));
        ...
        this.addButton(new GuiNpcButton(2, this.guiLeft + 4, y += 23, 50, 20, new String[]{"availability.always", "availability.after", "availability.before"}, this.availabitily.dialog3Available.ordinal()));
        ...
        this.addButton(new GuiNpcButton(3, this.guiLeft + 4, y += 23, 50, 20, new String[]{"availability.always", "availability.after", "availability.before"}, this.availabitily.dialog4Available.ordinal()));
