...
ISubGuiListener {
    ...
    public void func_73866_w_() {
        ...
        this.addTextField(new GuiNpcTextField(2, this, this.field_146289_q, this.guiLeft + 80, y += 22, 50, 18, this.ranged.getRange() + ""));
        ...
        this.addTextField(new GuiNpcTextField(3, this, this.field_146289_q, this.guiLeft + 80, y += 22, 50, 18, this.ranged.getDelayMin() + ""));
        ...
        this.addTextField(new GuiNpcTextField(6, this, this.field_146289_q, this.guiLeft + 80, y += 22, 50, 18, this.ranged.getBurst() + ""));
        ...
        this.addTextField(new GuiNpcTextField(7, this, this.field_146289_q, this.guiLeft + 80, y += 22, 100, 20, this.ranged.getSound(0)));
        ...
        this.addTextField(new GuiNpcTextField(11, this, this.field_146289_q, this.guiLeft + 80, y += 22, 100, 20, this.ranged.getSound(1)));
        ...
        this.addTextField(new GuiNpcTextField(10, this, this.field_146289_q, this.guiLeft + 80, y += 22, 100, 20, this.ranged.getSound(2)));
        ...
        this.addButton(new GuiNpcButtonYesNo(9, this.guiLeft + 100, y += 22, this.ranged.getHasAimAnimation()));
        this.addLabel(new GuiNpcLabel(9, "stats.aimWhileShooting", this.guiLeft + 5, y + 5));
        this.addButton(new GuiNpcButton(13, this.guiLeft + 100, y += 22, 80, 20, new String[]{"gui.no", "gui.whendistant", "gui.whenhidden"}, this.ranged.getFireType()));
