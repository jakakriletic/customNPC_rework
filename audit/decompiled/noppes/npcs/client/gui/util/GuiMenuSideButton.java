...
extends GuiNpcButton {
    ...
    public void func_191745_a(Minecraft minecraft, int i, int j, float partialTicks) {
        ...
        if (this.active) {
            this.func_73732_a(fontrenderer, text, this.field_146128_h + width / 2, this.field_146129_i + (this.field_146121_g - 8) / 2, 0xFFFFA0);
        } else if (this.field_146123_n) {
            this.func_73732_a(fontrenderer, text, this.field_146128_h + width / 2, this.field_146129_i + (this.field_146121_g - 8) / 2, 0xFFFFA0);
        } else {
            this.func_73732_a(fontrenderer, text, this.field_146128_h + width / 2, this.field_146129_i + (this.field_146121_g - 8) / 2, 0xE0E0E0);
        }
    }
