...
extends GuiMenuTopButton {
    ...
    public void func_191745_a(Minecraft minecraft, int i, int j, float partialTicks) {
        ...
        GuiMenuTopIconButton.itemRender.field_77023_b = 100.0f;
        ...
        GlStateManager.func_179140_f();
        GuiMenuTopIconButton.itemRender.field_77023_b = 0.0f;
    ...
    protected void drawHoveringText(List p_146283_1_, int p_146283_2_, int p_146283_3_, FontRenderer font) {
        if (!p_146283_1_.isEmpty()) {
            ...
            GuiMenuTopIconButton.itemRender.field_77023_b = 300.0f;
            int j1 = -267386864;
