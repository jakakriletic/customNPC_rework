...
IMouseListener {
    ...
    public void drawScreen(int xMouse, int yMouse) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (wordHightLight != null) {
                ...
                while (m.find()) {
                    ...
                    GuiTextArea.func_73734_a((int)(this.x + 1 + s), (int)posY2, (int)(this.x + 1 + e2), (int)(posY2 + this.container.lineHeight + 1), (int)-1728033792);
                }
            }
        ...
        if (this.hasVerticalScrollbar()) {
            ...
            GuiTextArea.func_73734_a((int)posX, (int)posY, (int)(posX + 5), (int)(posY + sbSize), (int)-2039584);
        }
    }
