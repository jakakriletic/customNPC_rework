...
GuiYesNoCallback {
    ...
    public void func_73866_w_() {
        ...
        if (this.selected != null) {
            ...
            this.addLabel(new GuiNpcLabel(0, I18n.func_74838_a((String)"schematic.width") + ": " + this.selected.getWidth(), this.guiLeft + 130, y += 21));
            this.addLabel(new GuiNpcLabel(1, I18n.func_74838_a((String)"schematic.length") + ": " + this.selected.getLength(), this.guiLeft + 130, y += 11));
            this.addLabel(new GuiNpcLabel(2, I18n.func_74838_a((String)"schematic.height") + ": " + this.selected.getHeight(), this.guiLeft + 130, y += 11));
            this.addButton(new GuiNpcButtonYesNo(4, this.guiLeft + 200, y += 14, this.tile.enabled));
            this.addLabel(new GuiNpcLabel(4, I18n.func_74838_a((String)"gui.enabled"), this.guiLeft + 130, y + 5));
            this.addButton(new GuiNpcButtonYesNo(7, this.guiLeft + 200, y += 22, this.tile.finished));
            this.addLabel(new GuiNpcLabel(7, I18n.func_74838_a((String)"gui.finished"), this.guiLeft + 130, y + 5));
            this.addButton(new GuiNpcButtonYesNo(8, this.guiLeft + 200, y += 22, this.tile.started));
            this.addLabel(new GuiNpcLabel(8, I18n.func_74838_a((String)"gui.started"), this.guiLeft + 130, y + 5));
            this.addTextField(new GuiNpcTextField(9, this, this.guiLeft + 200, y += 22, 50, 20, this.tile.yOffest + ""));
            this.addLabel(new GuiNpcLabel(9, I18n.func_74838_a((String)"gui.yoffset"), this.guiLeft + 130, y + 5));
            ...
            this.addLabel(new GuiNpcLabel(5, I18n.func_74838_a((String)"movement.rotation"), this.guiLeft + 130, y + 5));
    ...
    protected void func_146284_a(GuiButton guibutton) {
        ...
        if (guibutton.field_146127_k == 10) {
            this.save();
            GuiYesNo guiyesno = new GuiYesNo((GuiYesNoCallback)this, "", I18n.func_74838_a((String)"schematic.instantBuildText"), 0);
