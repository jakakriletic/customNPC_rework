...
extends GuiNPCInterface2 {
    ...
    public void func_73866_w_() {
        ...
        for (int i = 0; i < this.scenes.scenes.size(); ++i) {
            ...
            this.addButton(new GuiNpcButton(4 + i * 10, this.guiLeft + 232, y, 60, 20, new String[]{"gui.none", GameSettings.func_74298_c((int)ClientProxy.Scene1.func_151463_i()), GameSettings.func_74298_c((int)ClientProxy.Scene2.func_151463_i()), GameSettings.func_74298_c((int)ClientProxy.Scene3.func_151463_i())}, scene.btn));
            y += 22;
        }
    ...
    public void buttonEvent(GuiButton button) {
        if (button.field_146127_k < 60) {
            DataScenes.SceneContainer scene = this.scenes.scenes.get(button.field_146127_k / 10);
            if (button.field_146127_k % 10 == 1) {
                boolean bl = scene.enabled = ((GuiNpcButton)button).getValue() == 1;
            }
