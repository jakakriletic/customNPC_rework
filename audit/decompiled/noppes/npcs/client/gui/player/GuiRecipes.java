...
extends GuiNPCInterface {
    ...
    public void func_73863_a(int xMouse, int yMouse, float f) {
        ...
        for (i = 0; i < 4 && (index = i + this.page * 4) < this.recipes.size(); ++i) {
            ...
            if (irecipe.func_77571_b().func_190926_b()) continue;
            ...
            for (j = 0; j < recipe.field_77576_b; ++j) {
                for (k = 0; k < recipe.field_77577_c; ++k) {
                    ...
                    this.func_73729_b(x + j * 18, y + k * 18, 0, 0, 18, 18);
        ...
        for (i = 0; i < 4 && (index = i + this.page * 4) < this.recipes.size(); ++i) {
            ...
            irecipe = this.recipes.get(index);
            if (!(irecipe instanceof RecipeCarpentry) || (recipe = (RecipeCarpentry)irecipe).func_77571_b().func_190926_b()) continue;
            int x = this.guiLeft + 5 + i / 2 * 126;
            int y = this.guiTop + 15 + i % 2 * 76;
