...
extends GuiContainerNPCInterface {
    ...
    protected void func_146979_b(int par1, int par2) {
        for (int slot = 0; slot < 18; ++slot) {
            ...
            if (this.func_146978_c(x + 43, y + 1, 16, 16, par1, par2)) {
                ...
                if (!this.container.canBuy(item, item2, (EntityPlayer)this.player)) {
                    ...
                    if (!item.func_190926_b() && !NoppesUtilPlayer.compareItems((EntityPlayer)this.player, item, this.role.ignoreDamage, this.role.ignoreNBT)) {
                        this.func_73733_a(x + 17, y, x + 35, y + 18, 0x70771010, 0x70771010);
                    }
                    if (!item2.func_190926_b() && !NoppesUtilPlayer.compareItems((EntityPlayer)this.player, item2, this.role.ignoreDamage, this.role.ignoreNBT)) {
                        this.func_73733_a(x - 1, y, x + 17, y + 18, 0x70771010, 0x70771010);
                    }
                    title = I18n.func_74838_a((String)"trader.insufficient");
                    this.field_146289_q.func_78276_b(title, (this.field_146999_f - this.field_146289_q.func_78256_a(title)) / 2, 131, 0xDD0000);
                    GlStateManager.func_179109_b((float)0.0f, (float)0.0f, (float)-300.0f);
                } else {
                    title = I18n.func_74838_a((String)"trader.sufficient");
            ...
            if (!this.func_146978_c(x + 18, y, 16, 16, par1, par2)) continue;
