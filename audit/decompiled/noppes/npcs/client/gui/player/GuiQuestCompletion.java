...
implements ITopButtonListener {
    ...
    public void func_73866_w_() {
        super.func_73866_w_();
        String questTitle = I18n.func_74838_a((String)this.quest.getName());
        ...
        this.addButton(new GuiNpcButton(0, this.guiLeft + 38, this.guiTop + this.ySize - 24, 100, 20, I18n.func_74838_a((String)"quest.complete")));
    }
