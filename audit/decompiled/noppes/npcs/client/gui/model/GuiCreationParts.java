...
ICustomScrollListener {
    ...
    public GuiCreationParts(EntityNPCInterface npc) {
        ...
        Arrays.sort(this.parts, (o1, o2) -> {
            String s1 = I18n.func_74838_a((String)("part." + o1.part.name));
            String s2 = I18n.func_74838_a((String)("part." + o2.part.name));
    ...
    public void func_73866_w_() {
        ...
        if (this.scroll == null) {
            ...
            for (GuiPart part : this.parts) {
                list.add(I18n.func_74838_a((String)("part." + part.part.name)));
            }
        ...
        if (this.parts[selected] != null) {
            this.scroll.setSelected(I18n.func_74838_a((String)("part." + this.parts[GuiCreationParts.selected].part.name)));
    ...
    extends GuiPart {
        ...
        public int initGui() {
            ...
            if (this.data != null && this.eyes.isEnabled()) {
                ...
                GuiCreationParts.this.addButton(new GuiButtonBiDirectional(37, GuiCreationParts.this.guiLeft + 145, y += 25, 100, 20, new String[]{I18n.func_74838_a((String)"gui.down") + "x2", "gui.down", "gui.normal", "gui.up"}, this.eyes.eyePos + 1));
