...
extends GuiNPCInterface2 {
    ...
    public void func_73866_w_() {
        ...
        for (String names : this.potions.keySet()) {
            ...
            this.displays.put(I18n.func_135052_a((String)names, (Object[])new Object[0]) + " " + I18n.func_135052_a((String)("enchantment.level." + (this.job.effects.get(this.potions.get(names)) + 1)), (Object[])new Object[0]), names);
        }
    ...
    protected void func_146284_a(GuiButton guibutton) {
        ...
        if (button.field_146127_k == 13) {
            ...
            for (Potion p : Potion.field_188414_b) {
                this.job.effects.put(Potion.func_188409_a((Potion)p), this.potency);
            }
            this.scroll1.selected = -1;
            this.scroll2.selected = -1;
            this.func_73866_w_();
