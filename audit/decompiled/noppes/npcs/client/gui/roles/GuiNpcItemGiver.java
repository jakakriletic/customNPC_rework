...
extends GuiContainerNPCInterface2 {
    ...
    public void func_73866_w_() {
        ...
        this.addTextField(new GuiNpcTextField(0, (GuiScreen)this, this.field_146289_q, this.field_147003_i + 55, this.field_147009_r + 54, 90, 20, this.role.cooldown + ""));
        ...
        for (String line : this.role.lines) {
            this.addTextField(new GuiNpcTextField(i + 1, (GuiScreen)this, this.field_146289_q, this.field_147003_i + 150, this.field_147009_r + 6 + i * 24, 236, 20, line));
            ++i;
        }
        while (i < 3) {
            this.addTextField(new GuiNpcTextField(i + 1, (GuiScreen)this, this.field_146289_q, this.field_147003_i + 150, this.field_147009_r + 6 + i * 24, 236, 20, ""));
            ++i;
        }
