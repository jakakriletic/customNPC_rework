...
IGuiData {
    ...
    public void func_73866_w_() {
        ...
        this.addLabel(new GuiNpcLabel(7, I18n.func_74838_a((String)"spawner.posoffset") + " X:", this.guiLeft + 4, (y += 23) + 5));
        ...
        this.addLabel(new GuiNpcLabel(10, "spawner.type", this.guiLeft + 4, (y += 23) + 5));
    ...
    protected void func_146284_a(GuiButton guibutton) {
        ...
        if (button.field_146127_k >= 20 && button.field_146127_k < 26) {
            this.job.setJobCompound(button.field_146127_k - 19, null);
