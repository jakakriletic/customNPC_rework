...
implements IGuiData {
    ...
    public void func_73866_w_() {
        ...
        if (this.tile.isDetailed) {
            this.addLabel(new GuiNpcLabel(0, I18n.func_74838_a((String)"bard.ondistance") + " X:", this.guiLeft + 1, this.guiTop + 76, 0xFFFFFF));
            ...
            this.addLabel(new GuiNpcLabel(3, I18n.func_74838_a((String)"bard.offdistance") + " X:", this.guiLeft - 3, this.guiTop + 99, 0xFFFFFF));
