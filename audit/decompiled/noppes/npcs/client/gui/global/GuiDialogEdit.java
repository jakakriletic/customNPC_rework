...
ITextfieldListener {
    ...
    public void func_73866_w_() {
        ...
        int y = this.guiTop + 4;
        this.addButton(new GuiNpcButton(10, this.guiLeft + 330, y += 22, 50, 20, "selectServer.edit"));
        this.addLabel(new GuiNpcLabel(10, "advMode.command", this.guiLeft + 214, y + 5));
        this.addButton(new GuiNpcButtonYesNo(11, this.guiLeft + 330, y += 22, this.dialog.hideNPC));
        this.addLabel(new GuiNpcLabel(11, "dialog.hideNPC", this.guiLeft + 214, y + 5));
        this.addButton(new GuiNpcButtonYesNo(12, this.guiLeft + 330, y += 22, this.dialog.showWheel));
        this.addLabel(new GuiNpcLabel(12, "dialog.showWheel", this.guiLeft + 214, y + 5));
        this.addButton(new GuiNpcButtonYesNo(15, this.guiLeft + 330, y += 22, this.dialog.disableEsc));
