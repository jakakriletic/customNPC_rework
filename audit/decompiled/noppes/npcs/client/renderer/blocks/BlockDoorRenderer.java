...
extends BlockRendererInterface {
    ...
    public void func_192841_a(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (original.func_177229_b((IProperty)BlockDoor.field_176523_O) == BlockDoor.EnumDoorHalf.UPPER) {
        ...
        int meta = BlockNpcDoorInterface.func_176515_e((IBlockAccess)this.func_178459_a(), (BlockPos)tile.func_174877_v());
        Block b = lowerTile.blockModel;
        if (this.overrideModel()) {
            b = CustomItems.scriptedDoor;
        }
        IBlockState state = b.func_176203_a(meta);
        state = state.func_177226_a((IProperty)BlockDoor.field_176523_O, original.func_177229_b((IProperty)BlockDoor.field_176523_O));
        state = state.func_177226_a((IProperty)BlockDoor.field_176520_a, lowerState.func_177229_b((IProperty)BlockDoor.field_176520_a));
        state = state.func_177226_a((IProperty)BlockDoor.field_176519_b, lowerState.func_177229_b((IProperty)BlockDoor.field_176519_b));
        state = state.func_177226_a((IProperty)BlockDoor.field_176521_M, upperState.func_177229_b((IProperty)BlockDoor.field_176521_M));
        state = state.func_177226_a((IProperty)BlockDoor.field_176522_N, upperState.func_177229_b((IProperty)BlockDoor.field_176522_N));
