...
extends ModelBiped {
    ...
    private ModelScaleRenderer createScale(ModelRenderer renderer, EnumParts part) {
        ...
        ModelBipedAlt.func_178685_a((ModelRenderer)renderer, (ModelRenderer)model);
        ...
        if (player.advanced.job == 9 && (job = (JobPuppet)player.jobInterface).isActive()) {
            ...
            if (!job.larm.disabled) {
                ...
                if (player.display.getHasLivingAnimation()) {
                    this.field_178724_i.field_78808_h -= MathHelper.func_76134_b((float)(par3 * 0.09f)) * 0.05f + 0.05f;
                    this.field_178724_i.field_78795_f -= MathHelper.func_76126_a((float)(par3 * 0.067f)) * 0.05f;
                }
            }
