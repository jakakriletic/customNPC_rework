...
extends ModelRenderer {
    ...
    public void func_78794_c(float par1) {
        if (this.config != null) {
            GlStateManager.func_179109_b((float)this.config.transX, (float)this.config.transY, (float)this.config.transZ);
        }
        super.func_78794_c(par1);
        if (this.config != null) {
            GlStateManager.func_179152_a((float)this.config.scaleX, (float)this.config.scaleY, (float)this.config.scaleZ);
        }
    }
