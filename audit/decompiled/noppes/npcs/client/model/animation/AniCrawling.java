...
public class AniCrawling {
    public static void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity, ModelBiped model) {
        ...
        model.field_178720_f.field_78795_f = model.field_78116_c.field_78795_f = -0.95993114f;
        ...
        float movement = MathHelper.func_76134_b((float)(par1 * 0.8f + (float)Math.PI)) * par2;
        model.field_178724_i.field_78795_f = (float)Math.PI - movement * 0.25f;
        ...
        model.field_178723_h.field_78795_f = (float)Math.PI + movement * 0.25f;
