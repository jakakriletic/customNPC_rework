...
extends ModelPlayer {
    ...
    private ModelScaleRenderer createScale(ModelRenderer renderer, EnumParts part) {
        ...
        ModelPlayerAlt.func_178685_a((ModelRenderer)renderer, (ModelRenderer)model);
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
        ...
        if (!this.field_78093_q) {
            boolean bl = this.field_78093_q = player.currentAnimation == 1;
        }
        ...
        if (player.func_70608_bn()) {
            ...
            this.field_178720_f.field_78795_f = 0.7f;
            ...
            this.field_78115_e.field_78795_f = 0.5f / playerdata.getPartConfig((EnumParts)EnumParts.BODY).scaleY;
        }
        ...
        ModelPlayerAlt.func_178685_a((ModelRenderer)this.field_178722_k, (ModelRenderer)this.field_178733_c);
        ModelPlayerAlt.func_178685_a((ModelRenderer)this.field_178721_j, (ModelRenderer)this.field_178731_d);
        ModelPlayerAlt.func_178685_a((ModelRenderer)this.field_178724_i, (ModelRenderer)this.field_178734_a);
        ModelPlayerAlt.func_178685_a((ModelRenderer)this.field_178723_h, (ModelRenderer)this.field_178732_b);
        ModelPlayerAlt.func_178685_a((ModelRenderer)this.field_78115_e, (ModelRenderer)this.field_178730_v);
        ModelPlayerAlt.func_178685_a((ModelRenderer)this.field_78116_c, (ModelRenderer)this.field_178720_f);
    }
    ...
    protected EnumHandSide func_187072_a(Entity entityIn) {
        if (entityIn instanceof EntityLivingBase && ((EntityLivingBase)entityIn).field_82175_bq) {
            ...
            if (living.field_184622_au == EnumHand.MAIN_HAND) {
