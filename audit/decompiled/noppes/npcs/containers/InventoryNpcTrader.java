...
implements IInventory {
    ...
    public InventoryNpcTrader(String s, int i, ContainerNPCTrader con) {
        ...
        this.slotsCount = i;
        this.inventoryContents = NonNullList.func_191197_a((int)i, (Object)ItemStack.field_190927_a);
    }
    ...
    public void func_70299_a(int i, ItemStack itemstack) {
        if (!itemstack.func_190926_b()) {
            this.inventoryContents.set(i, (Object)itemstack.func_77946_l());
        }
        this.func_70296_d();
    }
    ...
    public ItemStack func_70304_b(int i) {
        return (ItemStack)this.inventoryContents.set(i, (Object)ItemStack.field_190927_a);
    }
