...
extends ContainerNpcInterface {
    ...
    public ContainerNPCFollowerHire(EntityNPCInterface npc, EntityPlayer player) {
        ...
        this.func_75146_a(new SlotNpcMercenaryCurrency(this.role, (IInventory)this.currencyMatrix, 0, 44, 35));
        for (int i1 = 0; i1 < 3; ++i1) {
            for (int l1 = 0; l1 < 9; ++l1) {
                this.func_75146_a(new Slot((IInventory)player.field_71071_by, l1 + i1 * 9 + 9, 8 + l1 * 18, 84 + i1 * 18));
            }
        }
