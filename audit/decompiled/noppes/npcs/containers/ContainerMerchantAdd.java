...
extends ContainerNpcInterface {
    ...
    public ContainerMerchantAdd(EntityPlayer player, IMerchant par2IMerchant, World par3World) {
        ...
        this.func_75146_a(new Slot((IInventory)this.merchantInventory, 0, 36, 53));
        this.func_75146_a(new Slot((IInventory)this.merchantInventory, 1, 62, 53));
        this.func_75146_a(new Slot((IInventory)this.merchantInventory, 2, 120, 53));
        for (i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
    ...
    public ItemStack func_82846_b(EntityPlayer par1EntityPlayer, int par2) {
        ...
        if (slot != null && slot.func_75216_d()) {
            ...
            if (par2 != 0 && par2 != 1 && par2 != 2 ? (par2 >= 3 && par2 < 30 ? !this.func_75135_a(itemstack1, 30, 39, false) : par2 >= 30 && par2 < 39 && !this.func_75135_a(itemstack1, 3, 30, false)) : !this.func_75135_a(itemstack1, 3, 39, false)) {
    ...
    public void func_75134_a(EntityPlayer par1EntityPlayer) {
        ...
        if (!this.world.field_72995_K) {
            ...
            if (!NoppesUtilServer.IsItemStackNull(itemstack = this.merchantInventory.func_70304_b(1))) {
                par1EntityPlayer.func_71019_a(itemstack, false);
            }
        }
    }
