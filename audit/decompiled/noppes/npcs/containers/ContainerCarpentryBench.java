...
extends Container {
    ...
    public ContainerCarpentryBench(InventoryPlayer par1InventoryPlayer, World par2World, BlockPos pos) {
        ...
        this.func_75146_a((Slot)new SlotNpcCrafting(par1InventoryPlayer.field_70458_d, this.craftMatrix, this.craftResult, 0, 133, 41));
    ...
    public void func_75130_a(IInventory par1IInventory) {
        if (!this.worldObj.field_72995_K) {
            ...
            plmp.field_71135_a.func_147359_a((Packet)new SPacketSetSlot(this.field_75152_c, 0, item));
        }
    }
    ...
    public boolean func_75145_c(EntityPlayer par1EntityPlayer) {
        return this.worldObj.func_180495_p(this.pos).func_177230_c() == CustomItems.carpentyBench && par1EntityPlayer.func_70092_e((double)this.pos.func_177958_n() + 0.5, (double)this.pos.func_177956_o() + 0.5, (double)this.pos.func_177952_p() + 0.5) <= 64.0;
    }
