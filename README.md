...
| Naslednji korak | **Zagon M3.3**: `.\r1-run.ps1` in `.\r1-run.ps1 -Krmiljenje 1` (popravek R1 pod stikalom `RwMountSteering`), nato M3.4. Glej [`docs/04-STANJE.md`](docs/04-STANJE.md) |
