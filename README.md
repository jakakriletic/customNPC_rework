...
| Naslednji korak | **M3.5** (`updateHitbox()` ob začetku/koncu jahanja). M3.3 in M3.4 zaključena (R1 popravljen pod `RwMountSteering=1`). Glej [`docs/04-STANJE.md`](docs/04-STANJE.md) |
