...
| Naslednji korak | **M3.4** (gating AI taskov med jahanjem). M3.3 zaključen: R1 popravljen pod stikalom `RwMountSteering=1`. Glej [`docs/04-STANJE.md`](docs/04-STANJE.md) |
