...
implements IPlayer {
    ...
    public void message(String message) {
        ((EntityPlayerMP)this.entity).sendMessage((ITextComponent)new TextComponentTranslation(NoppesStringUtils.formatText(message, this.entity), new Object[0]));
    }
    ...
    public void setGamemode(int type) {
        ((EntityPlayerMP)this.entity).setGameType(WorldSettings.getGameTypeById((int)type));
    }
    ...
    public int inventoryItemCount(String id, int damage) {
        Item item = (Item)Item.REGISTRY.getObject((Object)new ResourceLocation(id));
        if (item == null) {
    ...
    public IContainer getInventory() {
        if (this.inventory == null) {
            this.inventory = new ContainerWrapper((IInventory)((EntityPlayerMP)this.entity).inventory);
        }
    ...
    public IBlock getSpawnPoint() {
        ...
        return NpcAPI.Instance().getIBlock(((EntityPlayerMP)this.entity).world, pos);
    }
    ...
    public void resetSpawnpoint() {
        ((EntityPlayerMP)this.entity).setSpawnPoint(null, false);
    }
    ...
    public void removeAllItems(IItemStack item) {
        for (int i = 0; i < ((EntityPlayerMP)this.entity).inventory.getSizeInventory(); ++i) {
            ItemStack is = ((EntityPlayerMP)this.entity).inventory.getStackInSlot(i);
            if (is == null || !is.isItemEqual(item.getMCItemStack())) continue;
            ((EntityPlayerMP)this.entity).inventory.setInventorySlotContents(i, ItemStack.EMPTY);
        }
    }
    ...
    public boolean hasAchievement(String achievement) {
        StatBase statbase = StatList.getOneShotStat((String)achievement);
        return false;
    }
    ...
    public void setPos(IPos pos) {
        NoppesUtilPlayer.teleportPlayer((EntityPlayerMP)this.entity, pos.getX(), pos.getY(), pos.getZ(), ((EntityPlayerMP)this.entity).dimension);
    }
    ...
    public void kick(String message) {
        ((EntityPlayerMP)this.entity).connection.disconnect((ITextComponent)new TextComponentTranslation(message, new Object[0]));
    }
    ...
    public IContainer showChestGui(int rows) {
        ...
        this.closeGui();
        ((EntityPlayerMP)this.entity).openGui((Object)CustomNpcs.instance, EnumGuiType.CustomChest.ordinal(), ((EntityPlayerMP)this.entity).world, rows, 0, 0);
    ...
    public void playSound(String sound, float volume, float pitch) {
        ...
        Server.sendData((EntityPlayerMP)this.entity, EnumPacketClient.PLAY_SOUND, sound, pos.getX(), pos.getY(), pos.getZ(), Float.valueOf(volume), Float.valueOf(pitch));
    }
