...
IAvailability {
    ...
    public boolean isAvailable(EntityPlayer player) {
        long time;
        if (this.daytime == EnumDayTime.Day && (time = player.world.getWorldTime() % 24000L) > 12000L) {
            return false;
        }
        if (this.daytime == EnumDayTime.Night && (time = player.world.getWorldTime() % 24000L) < 12000L) {
            return false;
        }
    ...
    public void setDaytime(int type) {
        this.daytime = EnumDayTime.values()[MathHelper.clamp((int)type, (int)0, (int)2)];
    }
    ...
    public void setDialog(int i, int id, int type) {
        ...
        EnumAvailabilityDialog e = EnumAvailabilityDialog.values()[MathHelper.clamp((int)type, (int)0, (int)2)];
        if (i == 0) {
            this.dialogId = id;
    ...
    public void setQuest(int i, int id, int type) {
        ...
        EnumAvailabilityQuest e = EnumAvailabilityQuest.values()[MathHelper.clamp((int)type, (int)0, (int)5)];
        if (i == 0) {
            this.questId = id;
    ...
    public void setFaction(int i, int id, int type, int stance) {
        ...
        EnumAvailabilityFactionType e = EnumAvailabilityFactionType.values()[MathHelper.clamp((int)type, (int)0, (int)2)];
        EnumAvailabilityFaction ee = EnumAvailabilityFaction.values()[MathHelper.clamp((int)stance, (int)0, (int)2)];
        if (i == 0) {
            this.factionId = id;
    ...
    public void setScoreboard(int i, String objective, int type, int value) {
        ...
        EnumAvailabilityScoreboard e = EnumAvailabilityScoreboard.values()[MathHelper.clamp((int)type, (int)0, (int)2)];
        if (i == 0) {
