...
public class BlockData {
    ...
    public NBTTagCompound getNBT() {
        ...
        compound.setString("Block", ((ResourceLocation)Block.REGISTRY.getNameForObject((Object)this.state.getBlock())).toString());
    ...
    public static BlockData getData(NBTTagCompound compound) {
        ...
        Block b = Block.getBlockFromName((String)compound.getString("Block"));
        if (b == null) {
            return null;
        }
