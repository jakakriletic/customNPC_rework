...
implements ForgeChunkManager.LoadingCallback {
    ...
    public ForgeChunkManager.Ticket getTicket(EntityNPCInterface npc) {
        ...
        ticket = ForgeChunkManager.requestTicket((Object)CustomNpcs.instance, (World)npc.world, (ForgeChunkManager.Type)ForgeChunkManager.Type.ENTITY);
        if (ticket == null) {
            return null;
        }
    ...
    public void ticketsLoaded(List<ForgeChunkManager.Ticket> tickets, World world) {
        for (ForgeChunkManager.Ticket ticket : tickets) {
            ...
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkPos)new ChunkPos(MathHelper.floor((double)x), MathHelper.floor((double)z)));
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkPos)new ChunkPos(MathHelper.ceil((double)x), MathHelper.ceil((double)z)));
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkPos)new ChunkPos(MathHelper.floor((double)x), MathHelper.ceil((double)z)));
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkPos)new ChunkPos(MathHelper.ceil((double)x), MathHelper.floor((double)z)));
        }
    }
