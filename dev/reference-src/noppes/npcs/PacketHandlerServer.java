...
public class PacketHandlerServer {
    ...
    private void handlePacket(EnumPacketServer type, ByteBuf buffer, EntityPlayerMP player, EntityNPCInterface npc) throws Exception {
        if (type == EnumPacketServer.Delete) {
            ...
            player.openGui((Object)CustomNpcs.instance, gui, player.world, 0, 0, 0);
            ...
            MerchantRecipeList list = MerchantRecipeList.readFromBuf((PacketBuffer)new PacketBuffer(buffer));
            ...
            Entity entity = EntityList.createEntityFromNBT((NBTTagCompound)Server.readNBT(buffer), (World)player.world);
            ...
            Entity entity = NoppesUtilServer.spawnClone(compound, (double)x + 0.5, y + 1, (double)z + 0.5, player.world);
            if (entity == null) {
            ...
            SchematicController.Instance.save((ICommandSender)player, name, t, tile.getPos(), tile.height, tile.width, tile.length);
