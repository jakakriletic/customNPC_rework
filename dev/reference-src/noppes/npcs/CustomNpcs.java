...
public class CustomNpcs {
    ...
    public void load(FMLPreInitializationEvent ev) {
        ...
        proxy.load();
        ObfuscationReflectionHelper.setPrivateValue(RangedAttribute.class, (Object)((RangedAttribute)SharedMonsterAttributes.MAX_HEALTH), (Object)Double.MAX_VALUE, (int)1);
    }
    ...
    public void setAboutToStart(FMLServerAboutToStartEvent event) {
        ...
        for (ResourceLocation name : names) {
            Block block = (Block)Block.REGISTRY.getObject((Object)name);
