    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (m == null) {
            ...
            for (Map.Entry<String, Method> entry : command.subcommands.entrySet()) {
                sender.sendMessage((ITextComponent)new TextComponentTranslation(entry.getKey() + ": " + entry.getValue().getAnnotation(CommandNoppesBase.SubCommand.class).desc(), new Object[0]));
            }
        } else {
