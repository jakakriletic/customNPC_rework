...
extends ModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        for (int i = 0; i < this.Tail.length; ++i) {
            this.Tail[i].rotateAngleZ = this.rainboom ? 0.0f : MathHelper.cos((float)(f * 0.8f)) * 0.2f * f1;
        }
        ...
        for (int j = 0; j < this.Bodypiece.length; ++j) {
            this.Bodypiece[j].rotateAngleY = (float)((double)f12 * 0.2);
        }
        for (int k = 0; k < this.LeftWing.length; ++k) {
            this.LeftWing[k].rotateAngleY = (float)((double)f12 * 0.2);
        }
        for (int l = 0; l < this.RightWing.length; ++l) {
            this.RightWing[l].rotateAngleY = (float)((double)f12 * 0.2);
        }
        ...
        if (f5 > -9990.0f) {
            ...
            f16 *= f16 * f16;
            f16 = 1.0f - f16;
            float f22 = MathHelper.sin((float)(f16 * 3.141593f));
            float f28 = MathHelper.sin((float)(f5 * 3.141593f));
        ...
        if (this.isSneak && !this.isFlying) {
            ...
            for (int i4 = 0; i4 < this.LeftWingExt.length; ++i4) {
                this.LeftWingExt[i4].rotateAngleX = (float)((double)f17 + 2.3561947345733643);
            ...
            for (int i5 = 0; i5 < this.LeftWingExt.length; ++i5) {
                this.RightWingExt[i5].rotateAngleX = (float)((double)f17 + 2.3561947345733643);
            ...
            if (this.isPegasus) {
                if (!this.isFlying) {
                    for (int k3 = 0; k3 < this.LeftWing.length; ++k3) {
                        this.LeftWing[k3].rotateAngleX = (float)((double)f18 + 1.5707964897155762);
                    ...
                    for (int l3 = 0; l3 < this.RightWing.length; ++l3) {
                        this.RightWing[l3].rotateAngleX = (float)((double)f18 + 1.5707964897155762);
                    ...
                    for (int j4 = 0; j4 < this.LeftWingExt.length; ++j4) {
                        this.LeftWingExt[j4].rotateAngleX = (float)((double)f18 + 1.5707964897155762);
                    ...
                    for (int j5 = 0; j5 < this.RightWingExt.length; ++j5) {
                        this.RightWingExt[j5].rotateAngleX = (float)((double)f18 + 1.5707964897155762);
            ...
            float f36 = MathHelper.cos((float)(f2 * 0.09f)) * 0.05f + 0.05f;
            float f39 = MathHelper.sin((float)(f2 * 0.067f)) * 0.05f;
            this.unicornarm.rotateAngleZ += f36;
            this.unicornarm.rotateAngleX += f39;
            if (this.isPegasus && this.isFlying) {
                this.WingRotateAngleY = MathHelper.sin((float)(f2 * 0.067f * 8.0f)) * 1.0f;
                this.WingRotateAngleZ = MathHelper.sin((float)(f2 * 0.067f * 8.0f)) * 1.0f;
            ...
            for (int k5 = 0; k5 < this.Tail.length; ++k5) {
                ...
                this.Tail[k5].rotateAngleX = this.rainboom ? 1.571f + 0.1f * MathHelper.sin((float)f) : f61;
            }
        ...
        if (this.rainboom) {
            for (int j1 = 0; j1 < this.Tail.length; ++j1) {
                ...
                this.Tail[j1].rotationPointZ += 1.0f;
            }
        }
        if (this.isSleeping) {
        ...
        if (this.aimedBow) {
            if (this.isUnicorn) {
                ...
                float f31 = f2;
                this.unicornarm.rotateAngleZ += MathHelper.cos((float)(f31 * 0.09f)) * 0.05f + 0.05f;
                this.unicornarm.rotateAngleX += MathHelper.sin((float)(f31 * 0.067f)) * 0.05f;
            } else {
                float f21 = 0.0f;
                float f27 = 0.0f;
                this.RightArm.rotateAngleZ = 0.0f;
                ...
                float f32 = f2;
                this.RightArm.rotateAngleZ += MathHelper.cos((float)(f32 * 0.09f)) * 0.05f + 0.05f;
                this.RightArm.rotateAngleX += MathHelper.sin((float)(f32 * 0.067f)) * 0.05f;
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.isSleeping) {
            ...
            GlStateManager.translate((float)0.0f, (float)-0.5f, (float)-0.9f);
        }
        float scale = f5;
