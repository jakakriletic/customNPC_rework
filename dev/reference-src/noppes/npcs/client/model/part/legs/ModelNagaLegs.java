...
extends ModelRenderer {
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
        this.nagaPart1.rotateAngleY = MathHelper.cos((float)(par1 * 0.6662f)) * 0.26f * par2;
        this.nagaPart2.rotateAngleY = MathHelper.cos((float)(par1 * 0.6662f)) * 0.5f * par2;
        this.nagaPart3.rotateAngleY = MathHelper.cos((float)(par1 * 0.6662f)) * 0.26f * par2;
        this.nagaPart4.rotateAngleY = -MathHelper.cos((float)(par1 * 0.6662f)) * 0.16f * par2;
        this.nagaPart5.rotateAngleY = -MathHelper.cos((float)(par1 * 0.6662f)) * 0.3f * par2;
        this.nagaPart1.setRotationPoint(0.0f, 14.0f, 0.0f);
        this.nagaPart2.setRotationPoint(0.0f, 18.0f, 0.6f);
        this.nagaPart3.setRotationPoint(0.0f, 22.0f, -0.3f);
        this.nagaPart4.setRotationPoint(0.0f, 22.0f, 5.0f);
    ...
    public void render(float par7) {
        ...
        GlStateManager.scale((float)0.74f, (float)0.7f, (float)0.85f);
        GlStateManager.translate((float)this.nagaPart3.rotateAngleY, (float)0.66f, (float)0.06f);
        this.nagaPart4.render(par7);
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate((float)(this.nagaPart3.rotateAngleY + this.nagaPart4.rotateAngleY), (float)0.0f, (float)0.0f);
