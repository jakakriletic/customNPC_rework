...
implements ITextfieldListener {
    ...
    public void initGui() {
        ...
        this.addButton(new GuiNpcButton(15, this.guiLeft + 80, y += 22, 100, 20, new String[]{"movement.ground", "movement.flying", "movement.swimming"}, this.ai.movementType));
        ...
        if (this.ai.getMovingType() == 1) {
            ...
            this.addButton(new GuiNpcButton(3, this.guiLeft + 80, y += 22, 100, 20, new String[]{"stats.normal", "movement.sitting", "movement.lying", "movement.hug", "movement.sneaking", "movement.dancing", "movement.aiming", "movement.crawling"}, this.ai.animationType));
            this.addLabel(new GuiNpcLabel(3, "movement.animation", this.guiLeft + 4, y + 5));
            if (this.ai.animationType != 2) {
                this.addButton(new GuiNpcButton(4, this.guiLeft + 80, y += 22, 80, 20, new String[]{"movement.body", "movement.manual", "movement.stalking", "movement.head"}, this.ai.getStandingType()));
        ...
        if (this.ai.getMovingType() != 0) {
            this.addButton(new GuiNpcButton(12, this.guiLeft + 80, y += 22, 100, 20, new String[]{"stats.normal", "movement.sneaking", "movement.aiming", "movement.dancing", "movement.crawling", "movement.hug"}, EntityAIAnimation.getWalkingAnimationGuiIndex(this.ai.animationType)));
