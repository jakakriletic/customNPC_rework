...
extends GuiNPCInterface2 {
    ...
    public void initGui() {
        ...
        for (int i = 0; i < this.scenes.scenes.size(); ++i) {
            ...
            this.addButton(new GuiNpcButton(4 + i * 10, this.guiLeft + 232, y, 60, 20, new String[]{"gui.none", GameSettings.getKeyDisplayString((int)ClientProxy.Scene1.getKeyCode()), GameSettings.getKeyDisplayString((int)ClientProxy.Scene2.getKeyCode()), GameSettings.getKeyDisplayString((int)ClientProxy.Scene3.getKeyCode())}, scene.btn));
            y += 22;
        }
