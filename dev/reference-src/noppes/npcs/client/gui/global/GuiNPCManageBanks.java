...
IGuiData {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRenderer.drawString(I18n.translateToLocal((String)"bank.tabCost"), 23, 28, CustomNpcResourceListener.DefaultTextColor);
        this.fontRenderer.drawString(I18n.translateToLocal((String)"bank.upgCost"), 123, 28, CustomNpcResourceListener.DefaultTextColor);
        this.fontRenderer.drawString(I18n.translateToLocal((String)"gui.start"), 6, 70, CustomNpcResourceListener.DefaultTextColor);
        this.fontRenderer.drawString(I18n.translateToLocal((String)"gui.max"), 9, 100, CustomNpcResourceListener.DefaultTextColor);
    }
