...
ITextfieldListener {
    ...
    public void initGui() {
        ...
        this.addTextField(new GuiNpcTextField(0, (GuiScreen)this, this.fontRenderer, this.guiLeft + 8, this.guiTop + 8, 160, 20, this.container.recipe.name));
    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        if (button.id == 3) {
            this.save();
            this.scroll.clear();
            String name = I18n.translateToLocal((String)"gui.new");
