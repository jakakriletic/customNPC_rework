...
implements IGuiData {
    ...
    public void initGui() {
        ...
        this.addLabel(new GuiNpcLabel(11, "gui.detailed", this.guiLeft + 40, this.guiTop + 47, 0xFFFFFF));
        ...
        if (this.tile.isDetailed) {
            this.addLabel(new GuiNpcLabel(0, I18n.translateToLocal((String)"bard.ondistance") + " X:", this.guiLeft + 1, this.guiTop + 76, 0xFFFFFF));
            this.addTextField(new GuiNpcTextField(0, this, this.fontRenderer, this.guiLeft + 80, this.guiTop + 71, 30, 20, this.tile.onRangeX + ""));
            this.getTextField((int)0).numbersOnly = true;
            this.getTextField(0).setMinMaxDefault(0, 50, 6);
            this.addLabel(new GuiNpcLabel(1, "Y:", this.guiLeft + 113, this.guiTop + 76, 0xFFFFFF));
            this.addTextField(new GuiNpcTextField(1, this, this.fontRenderer, this.guiLeft + 122, this.guiTop + 71, 30, 20, this.tile.onRangeY + ""));
            this.getTextField((int)1).numbersOnly = true;
            this.getTextField(1).setMinMaxDefault(0, 50, 6);
            this.addLabel(new GuiNpcLabel(2, "Z:", this.guiLeft + 155, this.guiTop + 76, 0xFFFFFF));
            this.addTextField(new GuiNpcTextField(2, this, this.fontRenderer, this.guiLeft + 164, this.guiTop + 71, 30, 20, this.tile.onRangeZ + ""));
            this.getTextField((int)2).numbersOnly = true;
            this.getTextField(2).setMinMaxDefault(0, 50, 6);
            this.addLabel(new GuiNpcLabel(3, I18n.translateToLocal((String)"bard.offdistance") + " X:", this.guiLeft - 3, this.guiTop + 99, 0xFFFFFF));
            this.addTextField(new GuiNpcTextField(3, this, this.fontRenderer, this.guiLeft + 80, this.guiTop + 94, 30, 20, this.tile.offRangeX + ""));
            this.getTextField((int)3).numbersOnly = true;
            this.getTextField(3).setMinMaxDefault(0, 50, 10);
            this.addLabel(new GuiNpcLabel(4, "Y:", this.guiLeft + 113, this.guiTop + 99, 0xFFFFFF));
            this.addTextField(new GuiNpcTextField(4, this, this.fontRenderer, this.guiLeft + 122, this.guiTop + 94, 30, 20, this.tile.offRangeY + ""));
            this.getTextField((int)4).numbersOnly = true;
            this.getTextField(4).setMinMaxDefault(0, 50, 10);
            this.addLabel(new GuiNpcLabel(5, "Z:", this.guiLeft + 155, this.guiTop + 99, 0xFFFFFF));
            this.addTextField(new GuiNpcTextField(5, this, this.fontRenderer, this.guiLeft + 164, this.guiTop + 94, 30, 20, this.tile.offRangeZ + ""));
            this.getTextField((int)5).numbersOnly = true;
            this.getTextField(5).setMinMaxDefault(0, 50, 10);
        } else {
            this.addLabel(new GuiNpcLabel(0, "bard.ondistance", this.guiLeft + 1, this.guiTop + 76, 0xFFFFFF));
            this.addTextField(new GuiNpcTextField(0, this, this.fontRenderer, this.guiLeft + 80, this.guiTop + 71, 30, 20, this.tile.onRange + ""));
            this.getTextField((int)0).numbersOnly = true;
            this.getTextField(0).setMinMaxDefault(0, 50, 6);
            this.addLabel(new GuiNpcLabel(3, "bard.offdistance", this.guiLeft - 3, this.guiTop + 99, 0xFFFFFF));
