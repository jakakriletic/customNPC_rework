...
extends GuiNpcTextField {
    ...
    private int getStartLineY() {
        ...
        return MathHelper.ceil((float)(this.scrolledY * (float)this.listHeight / (float)this.font.height(this.getText())));
    }

    @Override
    public void drawTextBox(int mouseX, int mouseY) {
        GuiNpcTextArea.drawRect((int)(this.posX - 1), (int)(this.posY - 1), (int)(this.posX + this.width + 1), (int)(this.posY + this.height + 1), (int)-6250336);
        GuiNpcTextArea.drawRect((int)this.posX, (int)this.posY, (int)(this.posX + this.width), (int)(this.posY + this.height), (int)-16777216);
        int color = 0xE0E0E0;
            ...
            for (char c : wholeLine.toCharArray()) {
                if (this.font.width(line + c) > maxSize && this.wrapLine) {
                    if (lineCount >= startLine && lineCount < maxLine) {
                        this.drawString(null, line, this.posX + 4, this.posY + 4 + (lineCount - startLine) * this.font.height(line), color);
                    }
                    line = "";
                    ++lineCount;
                }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        tessellator.pos((double)p_146188_1_, (double)p_146188_4_, 0.0).endVertex();
        tessellator.pos((double)p_146188_3_, (double)p_146188_4_, 0.0).endVertex();
        tessellator.pos((double)p_146188_3_, (double)p_146188_2_, 0.0).endVertex();
        tessellator.pos((double)p_146188_1_, (double)p_146188_2_, 0.0).endVertex();
