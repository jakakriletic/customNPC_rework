...
implements IGuiData {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if (this.playerFactions.isEmpty()) {
            String noFaction = I18n.translateToLocal((String)"faction.nostanding");
    ...
    private void renderScreen() {
        ...
        for (int id = 0; id < size; ++id) {
            ...
            String standing = I18n.translateToLocal((String)"faction.friendly");
            int color = 65280;
            if (faction.defaultPoints < faction.neutralPoints) {
                standing = I18n.translateToLocal((String)"faction.unfriendly");
                color = 0xFF0000;
                points = points + "/" + faction.neutralPoints;
            } else if (faction.defaultPoints < faction.friendlyPoints) {
                standing = I18n.translateToLocal((String)"faction.neutral");
                color = 0xF2FF00;
