        ...
        for (int slot = 0; slot < 18; ++slot) {
            ...
            if (this.isPointInRegion(x + 43, y + 1, 16, 16, par1, par2)) {
                ...
                if (!this.container.canBuy(item, item2, (EntityPlayer)this.player)) {
                    GlStateManager.translate((float)0.0f, (float)0.0f, (float)300.0f);
                    ...
                    title = I18n.translateToLocal((String)"trader.insufficient");
                    this.fontRenderer.drawString(title, (this.xSize - this.fontRenderer.getStringWidth(title)) / 2, 131, 0xDD0000);
                    GlStateManager.translate((float)0.0f, (float)0.0f, (float)-300.0f);
                } else {
                    title = I18n.translateToLocal((String)"trader.sufficient");
            ...
            if (!this.isPointInRegion(x + 18, y, 16, 16, par1, par2)) continue;
