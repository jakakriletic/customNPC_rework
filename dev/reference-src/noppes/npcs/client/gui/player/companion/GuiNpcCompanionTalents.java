...
extends GuiNPCInterface {
    ...
    private void addExperience(int exp) {
        ...
        this.getLabel((int)(this.selected.id - 10)).label = this.role.talents.get((Object)talent) + "/" + this.role.getNextLevel(talent);
    }
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if (this.selected != null && this.mc.world.getWorldTime() - this.startPressedTime > 4L && this.lastPressedTime < this.mc.world.getWorldTime() && this.mc.world.getWorldTime() % 4L == 0L) {
            if (this.selected.mousePressed(this.mc, i, j) && Mouse.isButtonDown((int)0)) {
    ...
    extends GuiScreen {
        ...
        public void drawScreen(int i, int j, float f) {
            ...
            this.drawCenteredString(mc.fontRenderer, this.role.getTalentLevel(this.talent) + "", this.x + 20, this.y + 16, 0xFFFFFF);
