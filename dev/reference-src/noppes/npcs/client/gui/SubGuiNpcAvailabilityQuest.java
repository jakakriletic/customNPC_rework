...
implements GuiSelectionListener {
    ...
    public void initGui() {
        ...
        this.addButton(new GuiNpcButton(1, this.guiLeft + 4, y += 23, 90, 20, new String[]{"availability.always", "availability.after", "availability.before", "availability.whenactive", "availability.whennotactive", "availability.completed", "availability.canStart"}, this.availabitily.quest2Available.ordinal()));
        ...
        this.addButton(new GuiNpcButton(2, this.guiLeft + 4, y += 23, 90, 20, new String[]{"availability.always", "availability.after", "availability.before", "availability.whenactive", "availability.whennotactive", "availability.completed", "availability.canStart"}, this.availabitily.quest3Available.ordinal()));
        ...
        this.addButton(new GuiNpcButton(3, this.guiLeft + 4, y += 23, 90, 20, new String[]{"availability.always", "availability.after", "availability.before", "availability.whenactive", "availability.whennotactive", "availability.completed", "availability.canStart"}, this.availabitily.quest4Available.ordinal()));
