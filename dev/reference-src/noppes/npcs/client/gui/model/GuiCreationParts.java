...
ICustomScrollListener {
    ...
    public GuiCreationParts(EntityNPCInterface npc) {
        ...
        Arrays.sort(this.parts, (o1, o2) -> {
            String s1 = I18n.translateToLocal((String)("part." + o1.part.name));
            String s2 = I18n.translateToLocal((String)("part." + o2.part.name));
    ...
    public void initGui() {
        ...
        if (this.scroll == null) {
            ...
            for (GuiPart part : this.parts) {
                list.add(I18n.translateToLocal((String)("part." + part.part.name)));
            }
        ...
        if (this.parts[selected] != null) {
            this.scroll.setSelected(I18n.translateToLocal((String)("part." + this.parts[GuiCreationParts.selected].part.name)));
    ...
    extends GuiPart {
        ...
        public int initGui() {
            ...
            if (this.data != null && this.eyes.isEnabled()) {
                ...
                GuiCreationParts.this.addButton(new GuiButtonBiDirectional(37, GuiCreationParts.this.guiLeft + 145, y += 25, 100, 20, new String[]{I18n.translateToLocal((String)"gui.down") + "x2", "gui.down", "gui.normal", "gui.up"}, this.eyes.eyePos + 1));
                GuiCreationParts.this.addLabel(new GuiNpcLabel(37, "gui.position", GuiCreationParts.this.guiLeft + 102, y + 5, 0xFFFFFF));
                GuiCreationParts.this.addButton(new GuiNpcButtonYesNo(34, GuiCreationParts.this.guiLeft + 145, y += 25, this.eyes.glint));
                GuiCreationParts.this.addLabel(new GuiNpcLabel(34, "eye.glint", GuiCreationParts.this.guiLeft + 102, y + 5, 0xFFFFFF));
                GuiCreationParts.this.addButton(new GuiColorButton(35, GuiCreationParts.this.guiLeft + 170, y += 25, this.eyes.browColor));
                ...
                GuiCreationParts.this.addButton(new GuiColorButton(36, GuiCreationParts.this.guiLeft + 170, y += 25, this.eyes.skinColor));
