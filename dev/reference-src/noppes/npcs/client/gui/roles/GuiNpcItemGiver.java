...
extends GuiContainerNPCInterface2 {
    ...
    public void initGui() {
        ...
        this.addTextField(new GuiNpcTextField(0, (GuiScreen)this, this.fontRenderer, this.guiLeft + 55, this.guiTop + 54, 90, 20, this.role.cooldown + ""));
        ...
        for (String line : this.role.lines) {
            this.addTextField(new GuiNpcTextField(i + 1, (GuiScreen)this, this.fontRenderer, this.guiLeft + 150, this.guiTop + 6 + i * 24, 236, 20, line));
            ++i;
        }
        while (i < 3) {
            this.addTextField(new GuiNpcTextField(i + 1, (GuiScreen)this, this.fontRenderer, this.guiLeft + 150, this.guiTop + 6 + i * 24, 236, 20, ""));
            ++i;
        }
