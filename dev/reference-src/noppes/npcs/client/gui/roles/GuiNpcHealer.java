...
extends GuiNPCInterface2 {
    ...
    public GuiNpcHealer(EntityNPCInterface npc) {
        ...
        for (Potion p : Potion.REGISTRY) {
            this.potions.put(p.getName(), Potion.getIdFromPotion((Potion)p));
        }
    }
    ...
    public void initGui() {
        ...
        for (String names : this.potions.keySet()) {
            ...
            this.displays.put(I18n.format((String)names, (Object[])new Object[0]) + " " + I18n.format((String)("enchantment.level." + (this.job.effects.get(this.potions.get(names)) + 1)), (Object[])new Object[0]), names);
        }
    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        if (button.id == 13) {
            ...
            for (Potion p : Potion.REGISTRY) {
                this.job.effects.put(Potion.getIdFromPotion((Potion)p), this.potency);
            }
            this.scroll1.selected = -1;
            this.scroll2.selected = -1;
            this.initGui();
