...
ISubGuiListener {
    ...
    public void initGui() {
        ...
        this.addTextField(new GuiNpcTextField(2, this, this.fontRenderer, this.guiLeft + 80, y += 22, 50, 18, this.ranged.getRange() + ""));
        ...
        this.addTextField(new GuiNpcTextField(3, this, this.fontRenderer, this.guiLeft + 80, y += 22, 50, 18, this.ranged.getDelayMin() + ""));
        ...
        this.addTextField(new GuiNpcTextField(6, this, this.fontRenderer, this.guiLeft + 80, y += 22, 50, 18, this.ranged.getBurst() + ""));
        ...
        this.addTextField(new GuiNpcTextField(7, this, this.fontRenderer, this.guiLeft + 80, y += 22, 100, 20, this.ranged.getSound(0)));
        ...
        this.addTextField(new GuiNpcTextField(11, this, this.fontRenderer, this.guiLeft + 80, y += 22, 100, 20, this.ranged.getSound(1)));
        ...
        this.addTextField(new GuiNpcTextField(10, this, this.fontRenderer, this.guiLeft + 80, y += 22, 100, 20, this.ranged.getSound(2)));
