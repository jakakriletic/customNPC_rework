...
ICustomScrollListener {
    ...
    public void initGui() {
        ...
        if (this.data.containsValue(this.options.factionId)) {
            ...
            label = "";
            label = this.options.decreaseFactionPoints ? label + I18n.translateToLocal((String)"gui.decrease") : label + I18n.translateToLocal((String)"gui.increase");
            label = label + " " + this.options.factionPoints + " " + I18n.translateToLocal((String)"faction.points");
        ...
        if (this.data.containsValue(this.options.faction2Id)) {
            ...
            label = "";
            label = this.options.decreaseFaction2Points ? label + I18n.translateToLocal((String)"gui.decrease") : label + I18n.translateToLocal((String)"gui.increase");
            label = label + " " + this.options.faction2Points + " " + I18n.translateToLocal((String)"faction.points");
