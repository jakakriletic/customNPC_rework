...
IGuiData {
    ...
    public void initGui() {
        ...
        this.addButton(new GuiNpcButton(4, this.guiLeft + 82, y += 34, 56, 20, new String[]{"gui.no", "gui.yes"}, this.npc.isImmuneToFire() ? 1 : 0));
        ...
        this.addTextField(new GuiNpcTextField(16, this, this.guiLeft + 355, y += 22, 56, 20, this.stats.combatRegen + "").setNumbersOnly());
