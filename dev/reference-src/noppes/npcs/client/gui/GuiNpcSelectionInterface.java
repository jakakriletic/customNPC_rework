...
extends GuiNPCInterface {
    ...
    private String up = "..<" + I18n.translateToLocal((String)"gui.up") + ">..";
    private String root = "";
    ...
    public void initGui() {
        ...
        this.addLabel(new GuiNpcLabel(0, ss, this.width / 2 - this.fontRenderer.getStringWidth(ss) / 2, 20, 0xFFFFFF));
        ...
        this.getButton((int)3).enabled = !this.assets.isRoot;
    }
