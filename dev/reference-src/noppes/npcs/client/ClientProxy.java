 ...
 *  net.minecraft.client.particle.ParticleFlame
...
extends CommonProxy {
    ...
    public void spawnParticle(EntityLivingBase player, String string, Object ... ob) {
        if (string.equals("Block")) {
            ...
            int id = (Integer)ob[1];
            Block block = Block.getBlockById((int)(id & 0xFFF));
            ...
            for (int i = 0; i < 2; ++i) {
                EntityEnderFX fx = new EntityEnderFX(npc, (rand.nextDouble() - 0.5) * (double)player.width, rand.nextDouble() * (double)player.height - height - 0.25, (rand.nextDouble() - 0.5) * (double)player.width, (rand.nextDouble() - 0.5) * 2.0, -rand.nextDouble(), (rand.nextDouble() - 0.5) * 2.0, particles);
    ...
    public static void bindTexture(ResourceLocation location) {
        try {
            ...
            GlStateManager.bindTexture((int)ob.getGlTextureId());
        }
